...
function ProductAdmin() {
  ...
  const getProducts = async () => {
    const result = await PetJoy.getProducts();
    setProducts(result);
  };
  ...
  const addProduct = async () => {
    ...
    await PetJoy.addProduct(newProduct);
  ...
  const editProduct = async (id) => {
    ...
    await PetJoy.updateProduct(updatedProduct.id, updatedProduct);
    getProducts();
    setName("");
    setPrice("");
    setImgUrl("");
